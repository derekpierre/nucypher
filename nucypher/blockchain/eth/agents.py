...
from typing import Dict, Iterable, List, Tuple, Type, Any, Optional, cast, Iterator, NamedTuple
...
class ContractAgency:
    ...
    def get_agent(cls,
        ...
        try:
            ...
            agent = cast(Agent, agent_class(registry=registry, provider_uri=provider_uri, contract_version=contract_version))
