...
from nucypher.blockchain.eth.agents import (
    ContractAgency,
    PREApplicationAgent,
    SubscriptionManagerAgent, EthereumContractAgent
)
...
from nucypher.cli.options import (
    ...
    option_poa,
    option_provider_uri,
    option_registry_filepath, option_staking_provider_address,
)
...
def staking_providers(general_config, registry_options, staking_provider_address):
    ...
    emitter.echo(staking_providers_list)  # TODO: painter
...
def events(general_config, registry_options, contract_name, from_block, to_block, event_name, csv, csv_file, event_filters, legacy):
    ...
    for contract_name in contract_names:
        ...
        title = f" {agent.contract_name} {agent.contract.version} Events ".center(40, "-")
