...
TEACHER_NODES = {
    TACoDomains.MAINNET.name: (
        'https://closest-seed.nucypher.network:9151',
        'https://seeds.nucypher.network',
        'https://mainnet.nucypher.network:9151',
    ),
    TACoDomains.LYNX.name: ("https://lynx.nucypher.network:9151",),
    TACoDomains.TAPIR.name: ("https://tapir.nucypher.network:9151",),
    TACoDomains.ORYX.name: ("https://oryx.nucypher.network:9151",),
}
...
class Learner:
    ...
    def __init__(self,
        ...
        self.domain = domain
        self.taco_domain = TACoDomains.from_domain_name(self.domain)
